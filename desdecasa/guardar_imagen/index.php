...
function crear_imagen($datosB64){
  $binario= base64_decode($datosB64);
...
function guardar_imagen($datosimg,$idfoto,$idPublicacion,$NombreUsuario){
  $rutaArchivo='imagenes/publicacion/' .$NombreUsuario.'/'.$idPublicacion.'/'.$idfoto;
  imagepng($datosimg, $rutaArchivo, 5);
  return $rutaArchivo;
}
